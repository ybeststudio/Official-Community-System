# ENABLE_SHARED_PACK_CHANGE_LOCALE_PATH : UIScript 경로 변경, RampageGauge/RampageGauge2 아이콘 변경을 mall_icon 명령어로 대체하여 기본 세팅되었던 coin 리소스 제거
# * 좌측 하단의 몰아이콘(RampageGauge, RampageGauge2) 변경 시 참고 사항
# 1. mall_icon 명령어로 변경
# 2. 리소스 관리 : shared/common/mall_icon_list.txt
			...
			(
				{
					...
					"images" :
					(
						"shared/common/ui/Mall/emtpy_icon.sub",
					)
				},
				{
					"name" : "RampageGauge2",
